	...
	* instead of just copying a reference to the same Competition objects.
 	*/
 	public Team(Team otherTeam)
 	{
 		...
 		competition1 = new Competition (otherTeam.competition1.getCompetitionName(), 
 				otherTeam.competition1.getWinner(), otherTeam.competition1.getRunnerup(), 
 				otherTeam.competition1.getYear());
 		competition2 = new Competition (otherTeam.competition2.getCompetitionName(), 
 				otherTeam.competition2.getWinner(), otherTeam.competition2.getRunnerup(), 
